...
*>
*  =====================================================================
      SUBROUTINE SGGQRF_QL( N, M, P, A, LDA, TAUA, B, LDB, TAUB, WORK,
     $                   LWORK, INFO )
*
...
*     .. External Subroutines ..
      EXTERNAL           SGEQRF, SGERQF, SORMQR, XERBLA, SGERQF_QL
...
*
*      START = TIC()
      CALL SGERQF_QL( N, P, B, LDB, TAUB, WORK, LWORK, INFO )
